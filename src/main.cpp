...
const char *wifi_ssid = "Nathan";
const char *wifi_password = "didier13";
...
const char *client_id = "TD06_GP07";
...
void setup()
{
  ...
  {
    mqtt_client.publish("TD06_GP07/temp", String(temp_measure).c_str());
    mqtt_client.publish("TD06_GP07/relhum", String(relative_humidity_measure).c_str());
    Serial.println("ok");
  }
